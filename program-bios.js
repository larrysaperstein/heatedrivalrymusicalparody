...
// Update a person's bio here once, then regenerate standalone profile pages from tools/generate_profile_pages.py.
(function () {
  var profiles = {
    "andrew-young": {
      id: "andrew-young",
